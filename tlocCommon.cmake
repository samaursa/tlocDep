...
function(tloc_add_definitions_strict)
  ...
  if (TLOC_COMPILER_MSVC)
    ...
    set(CMAKE_C_FLAGS_DEBUG           "-DTLOC_DEBUG /Od ${MIN_REBUILD} ${CHECKS} ${RT_DEBUG} ${RTTI} ${UNWIND} ${MPC} /W4 ${WARN_ERR} /c ${PDB} /TP" PARENT_SCOPE)
    set(CMAKE_C_FLAGS_RELEASE         "-DTLOC_RELEASE /O2 /Ob2 /Oi /Ot /GL ${RT_RELEASE} ${RTTI} ${UNWIND} ${MPC} /Gy /W4 ${WARN_ERR} /c ${PDB} /TP" PARENT_SCOPE)
    set(CMAKE_C_FLAGS_RELWITHDEBINFO  "-DTLOC_RELEASE_DEBUGINFO /O2 /Ob2 /Oi /Ot ${MIN_REBUILD} ${RT_RELEASE} ${RTTI} ${UNWIND} ${MPC} /Gy /W4 ${WARN_ERR} /c ${PDB} /TP" PARENT_SCOPE)
