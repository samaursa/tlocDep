#ifndef TLOC_DEP_VERSION_H
#define TLOC_DEP_VERSION_H
...
#ifndef TLOC_DEP_VERSION_0_0_73_1360327737
...
// as our repository may not be up-to-date) may not be up-to-date)